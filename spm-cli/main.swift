...
let selectedDefinition: ScenarioDefinition = {
    switch scenario {
    case .stable:
        return ScenarioDefinition.quickStarts[0]
    case .escalating:
        return ScenarioDefinition.quickStarts[1]
    case .critical:
        return ScenarioDefinition.criticalDrill
    }
}()
...
let payload: [String: Any] = [
    ...
    "proof_bundle": [
        ...
        "reviewer_handoff": [
            "lane": selectedDefinition.reviewerHandoff.lane,
            "owner": selectedDefinition.reviewerHandoff.owner,
            "next_action": selectedDefinition.reviewerHandoff.nextAction,
        ],
    ],
    "two_minute_review": [
