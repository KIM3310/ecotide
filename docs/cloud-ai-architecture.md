# Cloud + AI Architecture Blueprint: ecotide
...
- **Current proof surface:** Repository-local proof surface for edge, mobile, and local-first runtime systems, backed by GitHub Actions validation.
- **Status:** active
- **Primary stack:** GitHub Actions validation
